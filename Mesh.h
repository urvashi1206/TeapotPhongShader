...
public:
    ...
    */
	...
	void draw1(mat4 viewMat, mat4 projMat, vec3 lightPos1, vec3 lightPos2, float time, vec3 eye);
	void draw2(mat4 viewMat, mat4 projMat, vec3 lightPos1, vec3 lightPos2, float time, vec3 eye);
